      ...
      if($_SESSION['grant']=='admin'){
        echo'       <ul class="nav navbar-nav">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="index_experimentateur.php">Expérimentateurs</a></li>
                    <li><a href="index_recherche.php">Recherche</a></li>
                    <li><a href="index_medicament.php">Médicaments</a></li>
                    <li><a href="index_teste.php">Teste</a></li>
                    <li><a href="index_animal.php">Animaux</a></li>
                    <li><a href="index_users.php">Utilisateurs</a></li>
                  </ul>
                </li>
              </ul>';
      }
